...
If you see `ModuleNotFoundError: No module named 'mysql'`, you are likely using Anaconda’s `scrapy` binary. Ensure `which scrapy` points to `.../virtual_enviornment/bin/scrapy` while the venv i[...] 
...
- More stores (Flipkart, Amazon, etc.)
